...
<?php echo '<script type="text/ng-template" id="field_body_price_type">'; ?>
    <div class="nbd-field-info" ng-show="check_depend(field.general, field.general.price_type)">
        <div class="nbd-field-info-1">
            <div><label><b><?php esc_html_e('Price type', 'web-to-print-online-designer'); ?></b> <nbd-tip data-tip="<?php esc_html_e('Here you can choose how the price is calculated. Depending on the field there various types you can choose.', 'web-to-print-online-designer'); ?>" ></nbd-tip></label></div>
        </div>
