        ...
        <div class="nbd-field-info-2">
            <div class="nbd-table-wrap">
                <table class="nbd-table" style="text-align: center;">
                    <thead>
                        <tr>
                            <th><?php esc_html_e('View name', 'web-to-print-online-designer'); ?></th>
                            <th><?php esc_html_e('View base', 'web-to-print-online-designer'); ?></th>
                    ...
                    <tbody>
                        <tr ng-repeat="(vIndex, view) in options.views">
                            ...
                            <td>
                                <a class="button btn-primary nbd-mini-btn" ng-click="removeView(vIndex)" title="<?php esc_html_e('Delete View', 'web-to-print-online-designer'); ?>"><span class="dashicons dashicons-no-alt"></span></a>
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr><td colspan="3"><a class="button btn-primary" ng-click="addView()"><?php esc_html_e('Add View', 'web-to-print-online-designer'); ?></a></td></tr>
                    </tfoot>
                </table>
            </div>
        </div>
        ...
        <div class="nbd-field-info-2">
            <div class="nbd-table-wrap">
                <table class="nbd-table" style="text-align: center;">
                    <thead>
                        <tr>
                            <th rowspan="2"><?php esc_html_e('Attribute', 'web-to-print-online-designer'); ?></th>
                            <th rowspan="2"><?php esc_html_e('Sub attribute', 'web-to-print-online-designer'); ?></th>
                            <th colspan="{{options.views.length}}"><?php esc_html_e('View', 'web-to-print-online-designer'); ?></th>
                        </tr>
                        <tr>
                        ...
                        <tr ng-repeat="pbcon in field.general.pb_config_flat">
                            ...
                            <td ng-repeat="view in options.views" style="text-align: left;">
                                <label class="view-config">
                                    <?php esc_html_e('Show in view', 'web-to-print-online-designer'); ?>
                                ...
                                <label class="view-config view-config-image">
                                    <?php esc_html_e('Image', 'web-to-print-online-designer'); ?>
                                    <div class="image-icon-wrap">
