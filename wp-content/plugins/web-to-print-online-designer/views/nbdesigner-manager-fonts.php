        ...
        <div class="inside">
            ...
            <div class="gg-font-option">
                ...
                <select ng-model="filterFont.category" ng-change="resetCurentPage()">
                    ...
                    <option value="serif"><?php esc_html_e('Serif','web-to-print-online-designer'); ?></option>
                    <option value="sans-serif"><?php esc_html_e('Sans Serif','web-to-print-online-designer'); ?></option>
                    <option value="display"><?php esc_html_e('Display','web-to-print-online-designer'); ?></option>
                    <option value="handwriting"><?php esc_html_e('Handwriting','web-to-print-online-designer'); ?></option>
                    <option value="monospace"><?php esc_html_e('Monospace','web-to-print-online-designer'); ?></option>
                </select>
