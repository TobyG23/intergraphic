<div class="nbd-signal">
    <a href="https://cmsmart.net/wordpress-plugins/woocommerce-online-product-designer-plugin" target="_blank">
        ...
        <div class='contents-wrapper'>
            <span class="contents">&copy;<?php esc_html_e('Netbase','web-to-print-online-designer'); ?>Netbase</span>
        </div>
    </a>
</div>
