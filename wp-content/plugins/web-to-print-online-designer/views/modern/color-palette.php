    ...
    <div class="nbd-color-palette-inner">
        <div class="working-palette" ng-hide="settings.hideColorPalette">
            ...
            <ul class="main-color-palette nbd-perfect-scroll">
                ...
                <li class="color-eyedropper" ng-click="initEyeDropper2($event, true)" title="<?php esc_html_e('Eyedropper','web-to-print-online-designer'); ?>" ng-if="settings['nbdesigner_enable_eyedropper'] == 'yes'">
        ...
        <div class="nbd-text-color-picker" id="nbd-global-color-picker" ng-class="globalPicker.active ? 'active' : ''">
            ...
            <div>
                <button class="nbd-button" ng-click="addColor(globalPicker.color);selectGlobalPicker(globalPicker.color);"><?php esc_html_e('Choose','web-to-print-online-designer'); ?></button>
            </div>
        </div>
    </div>
</div>
