...
<div class="wrap postbox nbdesigner-manager-product">
    ...
    <?php else: ?>
    <?php echo sprintf(wp_kses(__('No product, <a href="%s" target="_blank">view user guide</a>', 'web-to-print-online-designer'), array( 'a' => array('href' => array(),'target' => array()) )), 'https://cmsmart.net/community/woocommerce-online-product-designer-plugin/videos'); ?>
    <?php endif; ?>
</div>
