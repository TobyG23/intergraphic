...
(function ($, window) {
    var modern = {
        ...
        switchTabClipart: function() {
            $('.pc-tab-cliparts .nbd-tabs').nbTabClipart();
        },
    ...
    $.fn.nbTabClipart = function () {
        return this.each(function () {
            var $tab = $(this).find('.nbd-tab');
            var $tabContent = $('#tab-svg .nbd-tab-contents .nbd-tab-content');
            $tab.on('click', function () {
                var tabId = $(this).attr('data-tab');
                $tab.removeClass('active');
                $(this).addClass('active');
                $tabContent.removeClass('active');
                $('#tab-svg .nbd-tab-contents #' + tabId).addClass('active')
                $('#tab-svg .nbd-tab-contents .tab-scroll').stop().animate({
                    scrollTop: 0
                }, 100);
            });
        });
