    ...
    foreach ( $templates as $key => $temp ):
        if( $temp['type'] == 'solid' ){
            if( !isset( $products[ $temp['product_id'] ] ) ){
                ...
                $products[ $temp['product_id'] ] = $product;
            } else {
                $product    = $products[ $temp['product_id'] ];
            }
            $link_template  = add_query_arg(array(
                'design_id' => nbd_encode_design_id( $temp['tid'] )
...
?>
    <div class="nbdesigner-item" data-id="<?php echo( $temp['tid'] ); ?>" data-img="<?php echo( $temp['image'] ); ?>" data-title="<?php echo( $temp['title'] ); ?>">
        <div class="nbd-gallery-item">
            <div class="nbd-gallery-item-inner">
                <a href="<?php echo esc_url( $link_template ); ?>" onclick="previewTempalte(event, <?php echo( $temp['tid'] ); ?>)">
                    <img src="<?php echo esc_url( $temp['image'] ); ?>" class="nbdesigner-img"/>
                </a>
                <div class="nbd-gallery-item-more-acction-wrap">
                    <div class="nbd-gallery-item-more-acction preview <?php echo( $temp['type'] ); ?>" onclick="previewTempalte(event, <?php echo( $temp['tid'] ); ?>)">
                    ...
                    <div class="nbd-gallery-item-more-acction customize">
                        <a href="<?php echo esc_url( $link_template ); ?>"><?php esc_html_e('Customize', 'web-to-print-online-designer'); ?></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="nbd-like-icons">
                    <span class="nbd-like-icon like <?php if( in_array( $temp['tid'], $favourite_templates ) ) echo 'active'; ?>" onclick="updateFavouriteTemplate(this, 'unlike', <?php echo( $temp['tid'] ); ?>)">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                            <title><?php esc_html_e('Voted', 'web-to-print-online-designer'); ?></title>
                    ...
                    <span class="nbd-like-icon unlike <?php if( !in_array( $temp['tid'], $favourite_templates ) ) echo 'active'; ?>" onclick="updateFavouriteTemplate(this, 'like', <?php echo( $temp['tid'] ); ?>)">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                            <title><?php esc_html_e('Vote', 'web-to-print-online-designer'); ?></title>
            ...
            ?>
            <a class="nbd-edit-template" href="<?php echo esc_url( $link_edit_design ); ?>" title="<?php esc_html_e('Edit template', 'web-to-print-online-designer'); ?>">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="12" height="14" viewBox="0 0 12 14">
                    <title><?php esc_html_e('Edit template', 'web-to-print-online-designer'); ?></title>
    ...
    <div class="woocommerce-message woocommerce-message--info woocommerce-Message woocommerce-Message--info woocommerce-info">
        <?php esc_html_e('No template has found yet.', 'web-to-print-online-designer'); ?>
    </div>
<?php endif;