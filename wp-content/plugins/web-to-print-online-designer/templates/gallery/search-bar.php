...
$selected_type  = $search_type == 'design' ? esc_html__( 'Design name', 'web-to-print-online-designer') : ( $search_type == 'artist' ? esc_html__( 'Artist', 'web-to-print-online-designer') : esc_html__( 'All', 'web-to-print-online-designer') );
?>
