...
<p id="nbd-share-group">
    <?php esc_html_e('Share design', 'web-to-print-online-designer'); ?><br />
    <a href="#" data-href="https://facebook.com/sharer/sharer.php?u=" target="_blank" class="nbd-social" title="Facebook">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <title><?php esc_html_e('facebook','web-to-print-online-designer'); ?></title>
    ...
    <a href="#" data-href="https://twitter.com/share?url=" data-text="<?php esc_html_e('My design', 'web-to-print-online-designer'); ?>" target="_blank" class="nbd-social" title="Twitter">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <title><?php esc_html_e('twitter','web-to-print-online-designer'); ?></title>
    ...
    <a href="#" data-href="https://www.linkedin.com/shareArticle?mini=true&url=" target="_blank" class="nbd-social" title="Linkedin">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <title><?php esc_html_e('linkedin','web-to-print-online-designer'); ?></title>
    ...
    <a href="#" data-href="mailto:?subject=Check%20out%20my%20design!&body=" target="_blank" class="nbd-social" title="Mail">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <title><?php esc_html_e('mail','web-to-print-online-designer'); ?></title>
    ...
    <a href="#" data-href="http://pinterest.com/pin/create/button/?url=" data-description="<?php esc_html_e('My design', 'web-to-print-online-designer'); ?>" target="_blank" class="nbd-social" id="nbd-pinterest" title="Pinterest">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <title><?php esc_html_e('pinterest','web-to-print-online-designer'); ?></title>
    ...
    <a href="#" data-href="https://web.skype.com/share?url=" target="_blank" class="nbd-social" title="Skype">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <title><?php esc_html_e('skype','web-to-print-online-designer'); ?></title>
