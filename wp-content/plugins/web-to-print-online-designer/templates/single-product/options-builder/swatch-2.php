        ...
        <div class="nbd-swatch-wrap">
            ...
            <label class="nbd-swatch" style="<?php if( $attr['preview_type'] == 'i' ){echo 'background: url('.$image_url . ') 0% 0% / cover';}else{ 
                    if(isset( $attr['color2'] )){
                        $style  = "background: -moz-linear-gradient(top,  ". $attr['color'] ." 0%, ". $attr['color'] ." 50%, ". $attr['color2'] ." 51%, ". $attr['color2'] ." 100%);";
                        $style .= "background: -webkit-linear-gradient(top,  ". $attr['color'] ." 0%, ". $attr['color'] ." 50%, ". $attr['color2'] ." 51%, ". $attr['color2'] ." 100%);";
                        $style .= "background: linear-gradient(to bottom,  ". $attr['color'] ." 0%, ". $attr['color'] ." 50%, ". $attr['color2'] ." 51%, ". $attr['color2'] ." 100%);";
                        echo( $style ); 
                    }else{
