...
<div class="nbdesigner_frontend_container">
    ...
    <?php if( nbdesigner_get_option( 'nbdesigner_separate_design_buttons', 'no' ) == 'no' ): ?>
    <p>
        ...
        <div class="nbd-actions-wrap">
            ...
            <div class="nbd-action-wrap">
                <a class="button alt nbdesign-button upload-design" id="startUpload">
                    ...
                    <span><?php esc_html_e( 'Upload design', 'web-to-print-online-designer' ); ?></span>
                </a>
            </div>
            <?php endif; ?>
            ...
            <div class="nbd-action-wrap">
                <a class="button alt nbdesign-button start-design" id="useTemplate" href="<?php echo( $template_gallery_url );?>">
                    ...
                    <span><?php esc_html_e( 'Use templates', 'web-to-print-online-designer' ); ?></span>
                </a>
            </div>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    <h4 id="nbdesigner-preview-title" style="display: none;"><?php esc_html_e('Your artwork', 'web-to-print-online-designer'); ?></h4>
    ...
    <h4 id="nbdesigner-upload-title" style="display: none;"><?php esc_html_e('Upload file', 'web-to-print-online-designer'); ?></h4>
    <div id="nbdesigner_upload_preview"></div>
    <?php if($extra_price != ''): ?>
    <p><?php esc_html_e('Extra price for design', 'web-to-print-online-designer'); ?> + <?php echo( $extra_price ); ?></p>
    <?php endif; ?>
...
<div id="container-online-designer" data-iframe="<?php echo esc_url( $src ); ?>">
    <?php if( $layout == 'c' ): ?>
    ...
    <?php
        ...
        $option         = maybe_unserialize( get_post_meta( $pid, '_nbdesigner_upload', true ) );
        $design_option  = maybe_unserialize( get_post_meta( $pid, '_nbdesigner_option', true ) );
    ?>
    <!-- No inline scripts or styles unless dynamic. -->
    <script type="text/javascript">
        ...
        <div class="nbd__pop__content">
            <div class="nbd__pop__content_wrapper <?php if( ( $show_button_use_our_template || $show_button_hire_us ) && $_enable_upload ) echo 'nbd__pop_wide'; ?>">
                <div class="__content_wrapper">
                    <div class="content__header"><?php esc_html_e('How would you like to design your', 'web-to-print-online-designer'); ?> <b><?php esc_html_e( $product->get_title() ); ?></b></div>
...
<script>
    ...
    var nbu_advanced_upload = "<?php echo  isset($advanced_upload) && $advanced_upload ? '1' : '0'; ?>";
</script>