...
<div class="layout__item">
    <a style="display: block; width: 100%;color: unset;" href="<?php echo( $template_gallery_url ); ?>">
        ...
        <div class="item__layout use_our_design">
            ...
            <div class="tile__text-wrap">
                <div class="tile__text-wrap-inner">
                    <h3 class="h__block"><?php esc_html_e('Use our templates', 'web-to-print-online-designer'); ?></h3>
                    <ul>
                        <li>- <?php esc_html_e('Looking for inspiration', 'web-to-print-online-designer'); ?></li>
                        <li>- <?php esc_html_e('Want simple customization', 'web-to-print-online-designer'); ?></li>
                    </ul>
                </div>
