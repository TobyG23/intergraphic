...
<p><?php echo sprintf(esc_html__( "Your order with order number %s now has the following status: %s", 'web-to-print-online-designer'),$order->get_order_number(),'<b>' . esc_html__( $reason, 'web-to-print-online-designer').'</b>'); ?></p>
