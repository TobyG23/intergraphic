...
?>
<h2 class="nbdl-store-dashboard-head"><?php esc_html_e('Withdraw', 'web-to-print-online-designer'); ?></h2>
    ...
    <div class="nbdl-toggle-panel" id="nbdl-withdraw-request">
        <?php if( ! $has_withdraw_balance ): 
            nbdesigner_render_template("launcher/store/notification.php", array(
                'type'      => 'error',
                'message'   => esc_html__( 'You don\'t have sufficient balance for a withdraw request!', 'web-to-print-online-designer' )
            ));
        elseif( $has_pending_request ): 
            $pending_warning = sprintf( '<div>%s</div><div>%s</div>', esc_html__( 'You already have pending withdraw request(s).', 'web-to-print-online-designer' ), esc_html__( 'Please submit your request after approval or cancellation of your previous request.', 'web-to-print-online-designer' ) );
            nbdesigner_render_template("launcher/store/notification.php", array(
                'type'      => 'error',
