...
class NBD_Admin_Setup_Wizard {
    ...
    private $enabled_printcart_api = false;
    private $steps = array();
    ...
    public function setup_wizard() {
        ...
        $this->enabled_printcart_api   = NBD_Printcart_API::enable_printcart_api();
        $this->is_next = NBD_Printcart_API::check_connection_with_printcart() && $is_https;
    ...
    public function nbd_setup_general_setup(){
        ...
        <form method="post" class="general-step">
            <div class="nbd-setup-shipping-unit">
                <?php if($this->enabled_printcart_api): ?>
                <p>
