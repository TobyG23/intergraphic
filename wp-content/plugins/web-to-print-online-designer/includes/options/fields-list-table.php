...
class NBD_Options_List_Table extends WP_List_Table {
    ...
    function get_columns() {
        $columns = array(
            ...
            'published'     => esc_html__('Status', 'web-to-print-online-designer'),
            'priority'      => esc_html__('Priority', 'web-to-print-online-designer'),
            'apply_for'     => esc_html__('Applied for', 'web-to-print-online-designer'),
            'product_ids'   => esc_html__('Products', 'web-to-print-online-designer'),
            'product_cats'  => esc_html__('Categories', 'web-to-print-online-designer'),
