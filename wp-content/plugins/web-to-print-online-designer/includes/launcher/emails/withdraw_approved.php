...
if ( ! class_exists( 'NBDL_Withdraw_Approved' ) ) {
    ...
    class NBDL_Withdraw_Approved  extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title          = esc_html__( 'NBDesigner Withdraw Approved', 'web-to-print-online-designer' );
            $this->description    = esc_html__( 'These emails are sent to designer when a designer withdraw request is approved', 'web-to-print-online-designer' );
        ...
        public function get_default_subject() {
            return esc_html__( '[{site_name}] Your withdrawal request was approved', 'web-to-print-online-designer' );
        }

        public function get_default_heading() {
            return esc_html__( 'Withdrawal request for {amount} is approved', 'web-to-print-online-designer' );
        }
