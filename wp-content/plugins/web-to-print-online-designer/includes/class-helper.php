    ...
    class Nbdesigner_Helper{
        public static function settings_helper(){
            ...
            $screen->set_help_sidebar(
                ...
                '<p>' . esc_html__('<a class="button" href="https://cmsmart.net/support_ticket" target="_blank">Support ticket</a>', 'web-to-print-online-designer') . '</p>' .
                '<p>' . esc_html__('<a class="button" href="https://cmsmart.net/community/woocommerce-online-product-designer-plugin" target="_blank">Forum</a>', 'web-to-print-online-designer') . '</p>'. 
                '<p>' . esc_html__('<a class="button" href="https://cmsmart.net/community/woocommerce-online-product-designer-plugin/userguides" target="_blank">User guide</a>', 'web-to-print-online-designer') . '</p>' .
